<#
.SYNOPSIS
    Desktop Management Logoff Script - Windows 10
    
.DESCRIPTION
    Main entry point for Desktop Management Suite during user logoff on Windows 10.
    Uses workflow engine to execute steps defined in Config\Workflow-Logoff.psd1
...
.EXAMPLE
    ...
    .\DesktopManagement-Logoff.ps1 -VerboseLogging
    
.NOTES
    Version: 2.0.0
    Replacement for: VB/DesktopManagement.wsf //Job:GDP_10_Logoff
    
    To add/remove/reorder actions:
    - Edit Config\Workflow-Logoff.psd1
...
Write-DMLog "Desktop Management Suite - Logoff Script" -NoTimestamp
...
# ============================================================================
Write-DMLog "========================================" -NoTimestamp
Write-DMLog "Desktop Management Logoff - Completed" -NoTimestamp
Write-DMLog "========================================" -NoTimestamp
