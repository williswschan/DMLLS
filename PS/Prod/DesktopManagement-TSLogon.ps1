<#
.SYNOPSIS
    Desktop Management Logon Script - Terminal Server/Citrix
    
.DESCRIPTION
    Main entry point for Desktop Management Suite during user logon on Terminal Server/Citrix.
    Uses workflow engine to execute steps defined in Config\Workflow-TSLogon.psd1
...
.EXAMPLE
    ...
    .\DesktopManagement-TSLogon.ps1 -VerboseLogging
    
.NOTES
    Version: 2.0.0
    Replacement for: VB/DesktopManagement.wsf //Job:GDP_TS_Logon
    
    To add/remove/reorder actions:
    - Edit Config\Workflow-TSLogon.psd1
...
Try {
    ...
    # Import inventory modules (needed by Drive Mapper)
...
Write-DMLog "Desktop Management Suite - TS Logon Script" -NoTimestamp
...
# ============================================================================
Write-DMLog "========================================" -NoTimestamp
Write-DMLog "Desktop Management TS Logon - Completed" -NoTimestamp
Write-DMLog "========================================" -NoTimestamp
