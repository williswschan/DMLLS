...
Class InventoryUserSessions
	...
	Function AddUserSession(UserId, UserDomain, OuMapping, HostName, Domain, SiteName, City)
		Dim invUserSession
...
Function InsertLogonInventory(ByRef Main, UserSessions)
	...
	strRequest = _
		...
		" <soap:Body>" &_
		"  <InsertLogonInventory xmlns=""http://webtools.japan.nom"">" &_
		UserSessions.ToXml &_
		"  </InsertLogonInventory>" &_
		" </soap:Body>" &_
		"</soap:Envelope>"
...
Function InsertLogonSession(ByRef Main)
	...
	InventoryUserSessions.AddUserSession  _
			...
			Main.Computer.CityCode
	
	Main.LogFile.Log "Inventory Logon: About to insert following data:" &_
			" User Name: " & Main.User.Name &_
			" User Domain: " & Main.User.Domain &_
			" User OuMapping: " & Main.User.OuMapping &_
			" Computer Name: " & Main.Computer.Name &_
			" Computer Domain: " & Main.Computer.Domain &_
			" Computer Site: " & Main.Computer.Site &_
			" Computer CityCode: " & Main.Computer.CityCode, False
